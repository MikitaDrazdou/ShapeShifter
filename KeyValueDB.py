...
#postgre.addImage(table_name="vector_model", embedding=str([1,2,3,4]), url="http//45.4545.54")
response = postgre.getUrl(table_name="vector_model", embedding=str([1,2,3,4]))
print(response[0][0])
